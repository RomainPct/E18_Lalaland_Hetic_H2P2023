...
<section id="musicPageContainer">
    ...
    <div id="musicPageContainer__Sub">
        ...
        <div id="musicPageContainer__Sub__rightBox">
             <img id="albumCover" src="../assets/images/imagesMusique/albumcover.jpg" alt="album">
             <div id="musicPageContainer__Sub__rightBox__iconsBox">
             <a href=""><img src="../assets/images/imagesMusique/logovinyl.png" alt="album"></a>
             </div>
        </div>
    </div>
